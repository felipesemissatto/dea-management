...
@Slf4j
public class ProjectUpdateUploadValidationTests {
    @Autowired
    ...
    @BeforeEach
    void beforeEach() {
        log.info("Before each test in " + ProjectUpdateUploadValidationTests.class.getSimpleName());
    }

    @BeforeAll
    void beforeSuiteTest() {
        log.info("Before all tests in " + ProjectUpdateUploadValidationTests.class.getSimpleName());
    }
